...
//compiler related:
const CONTRACT_NAME = "LeadcoinCrowdsale";
...
//LeadcoinCrowdsale constructor params:
...
async function processContract(contractFilePAth) {
    ...
    LeadcoinCrowdsaleCompiled = copmiled.contracts[":" + CONTRACT_NAME];
    var bytecode = LeadcoinCrowdsaleCompiled.bytecode
    var abi = LeadcoinCrowdsaleCompiled.interface;
...
function deployContract() {
    ...
    new eth.Contract(JSON.parse(LeadcoinCrowdsaleCompiled.interface), null, {
        data: '0x' + LeadcoinCrowdsaleCompiled.bytecode
    })
        .deploy({
